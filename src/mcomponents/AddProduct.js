...
import stl from '../css/AddProduct.module.css'
import CloseIcon from '../components/CloseIcon'
import { Link, useNavigate } from 'react-router-dom';
import SuccessfullyAddedPopup from './SuccessfullyAddedPopup'
                ...
                <div id={stl.pFormContainer}>
                    <div id={stl.pFormInnerContainer}>
                        <form >
                            ...
                            <div id={stl.belowHeadRow}>
                                <div id={stl.firstcol}>
                                    <div className={stl.formItems}>
                                        <label htmlfor="pname" className={stl.lbl}>Product Name:</label>
                                    ...
                                    <div className={stl.formItems}>
                                        <label htmlfor="pmodal" className={stl.lbl}>Modal :</label>
                                    ...
                                    <div className={stl.formItems}>
                                        <label htmlfor="ptype" className={stl.lbl}>Product Type :</label>
                                    ...
                                    <div className={stl.formItems}>
                                        <label htmlfor="pcode" className={stl.lbl}>SKU Code :</label>
                                        <input type="text" name='pcode' id={stl.pcode} />
                                    </div>
                                    <div className={stl.formItems}>
                                        <label htmlfor="pmc" className={stl.lbl}>AMC/CMC :</label>
                                    ...
                                    <div className={stl.formItems} id={stl.amcDuration}>
                                        <div>
                                            <label htmlfor="amcstart" className={stl.lbl}>Start Date :</label>
                                            <input type="date" name='amcstart' id={stl.amcstart} />
                                        </div>
                                        <div>
                                            <label htmlfor="amcend" className={stl.lbl}>End Date :</label>
                                ...
                                <div id={stl.secondCol}>
                                    <div className={stl.formItems}>
                                        <label htmlfor="cname" className={stl.lbl}>Company Name</label>
                                        <input type="text" name='cname' id={stl.cname} />
                                    </div>
                                    <div className={stl.formItems}>
                                        <label htmlfor="nos" className={stl.lbl}>Available Model nos :</label>
                                        <input type="text" name='nos' id={stl.nos} />
                                    </div>
                                    <div className={stl.formItems}>
                                        <label htmlfor="prscmnpy" className={stl.lbl}>Proposed Company:</label>
                                    ...
                                    <div className={stl.formItems}>
                                        <label htmlfor="sac" className={stl.lbl}>HSN/SAC Code :</label>
                                        <input type="text" name='sac' id={stl.sac} />
                                    </div>
                                    <div className={stl.formItems}>
                                        <label htmlfor="warranty" className={stl.lbl}>Warranty :</label>
                                        <input type="text" name='warranty' id={stl.sac} />
                                    </div>
                                    <div className={stl.formItems}>
                                        <label htmlfor="expiry" className={stl.lbl}>Expiry Date :</label>
                            ...
                            <div id={stl.descRow}>
                                <div >
                                    <div className={stl.descLbl}>
                                        <label htmlFor="pdesc" className={stl.lbl}>Product Description :</label>

                                    </div>
                                    <textarea name="pdesc" id={stl.pdesc} rows={5} cols={80}></textarea>
                                </div>
                                <div id={stl.descFileContianer}>
                                    <div className={stl.descLbl}>
                                        <label htmlFor="pimg" className={stl.lbl}>Product Image :</label>
                            ...
                            <div id={stl.productPricingContainer}>
                                ...
                                <div id={stl.productPricing}>
                                    <div >
                                        <div>
                                            <label htmlfor="quant" className={stl.lbl}>Quantity :</label>

                                        </div>
                                        <input type="text" name='quant' id={stl.quant} className={stl.pnp} placeholder='Qautity' />
                                    </div>
                                    <div >
                                        <div>
                                            <label htmlfor="cprice" className={stl.lbl}>Company Price :</label>

                                        </div>
                                        <input type="text" name='cprice' id={stl.cprice} className={stl.pnp} placeholder='Price' />
                                    </div>
                                    <div >
                                        <div>
                                            <label htmlfor="gst" className={stl.lbl}>Applicable GST :</label>
                            ...
                            <div id={stl.technical}>
                                ...
                                <div id={stl.techTextArea}>
                                    <textarea name="technical" rows={5} cols={50} id=" technical" placeholder='Write here...'></textarea>
                                    <input type="file" id={stl.techfile} name='techfile' />
                                </div>
                                <div id={stl.techInfo}>
                                    <div>
                                        <div>
                                            <label htmlFor="dimension" className={stl.lbl}>Dimension :</label>
                                    ...
                                    <div>
                                        <div>
                                            <label htmlFor="material" className={stl.lbl}>Materials :</label>
                                    ...
                                    <div>
                                        <div>
                                            <label htmlFor="performance" className={stl.lbl}>Performance :</label>

                                        </div>
                                        <input type='text' name="performance" id={stl.performance} />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id={stl.approvedBy}>
                        ...
                        <div id={stl.approveInner}>
                            <p>Approved By :</p>
                            <p><strong>Mayur Bansal</strong></p>
                            <p><strong>Purchased Manager Unisol</strong></p>
                        </div>
                    ...
                    <div className={stl.formBtnContainer}>
                        {/* <Link onClick={() => (navigate(-1))}> */}
                        <button type="submit" onClick={handlerclick}>Update</button>
