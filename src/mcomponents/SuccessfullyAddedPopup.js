...
import stl from '../css/SuccessfullyAddedPopup.module.css'
        ...
        <div style={popupStyles}>
            ...
            <div id={stl.popupContent}>
                <div id={stl.popupInnner}>
                    ...
                    <p id={stl.msg2}><img src="./assets/rightIcon.png" alt="right Symbol" /></p>
                    <p id={stl.msg2}>The Product has been added Successfully</p>
                    <button id={stl.canbtn} onClick={handleClick}>Cancel</button>
                </div>
