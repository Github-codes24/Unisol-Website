...
import stl from '../css/CreatePurchaseOrder.module.css'
                        ...
                        <div id={stl.secondRow}>
                            <div id={stl.firstCol}>
                                ...
                                <div className={stl.purchaseInputInner}>
                                    <label htmlFor="cname" className={stl.plbl}>Client Name</label>
                                    ...
                                    <tbody>
                                        {
                                            addRow?.map((item, index) => (
                                                <tr key={index} className={stl.dataRow}>
                                                    <td>
                                                        <input type="text" value={item.itemNo} onChange={(e) => handleChange(index, "itemNo", e.target.value)} className={stl.editableIinput} />
                                                    </td>
                                                    <td>
                                                        <input type="text" value={item.quantiy} onChange={(e) => handleChange(index, "quantiy", e.target.value)} className={stl.editableIinput} />
                                                    </td>
                                                    <td>
                                                        <input type="text" value={item.unitPrice} onChange={(e) => handleChange(index, "unitPrice", e.target.value)} className={stl.editableIinput} />
                                                    </td>
                                                    <td>
                                                        <input type="text" value={item.taxableTotal} onChange={(e) => handleChange(index, "taxableTotal", e.target.value)} className={stl.editableIinput} />
                                                    </td>
                                                    <td >
                                                        <td>
                                                            <input type="text" value={item.rate} onChange={(e) => handleChange(index, "rate", e.target.value)} className={stl.editableIinput} />
                                                        </td>
                                                        <td>
                                                            <input type="text" value={item.amt} onChange={(e) => handleChange(index, "amt", e.target.value)} className={stl.editableIinput} />
                                                        </td>
                                                    </td>

                                                    <td>
                                                        <input type="text" value={item.total} onChange={(e) => handleChange(index, "total", e.target.value)} className={stl.editableIinput} />
                                                    </td>
                                                </tr>
                                            ))
                                        }
                    ...
                    <div id={stl.athoriseSignContainer}>
                        <div id={stl.authFirst}>
                            ...
                            <div className={stl.authInputContainer}>
                                <label htmlFor="authname" className={stl.authlbl}>Name :</label>
                                <input type="text" name='authname' id={stl.authname} />
                            </div>
                            <div className={stl.authInputContainer}>
                                <label htmlFor="dasig" className={stl.authlbl}>Dasignation :</label>
                                <input type="text" name='dasig' id={stl.dasig} />
                            </div>
                            <div className={stl.authInputContainer}>
                                <label htmlFor="authmail" className={stl.authlbl}>E-mail :</label>
                                <input type="text" name='authmail' id={stl.authmail} />
                            </div>
                            <div className={stl.authInputContainer}>
                                <label htmlFor="authcontact" className={stl.authlbl}>Contact :</label>
